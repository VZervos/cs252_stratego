...
public class Player {
    ...
    public void setName(String name) {
        if (name.isEmpty()) this.name="player"+this.id;
    }
    /**
     * Gets player's name
     ...
     */
    public void setFlag(boolean status) {this.flag=status;}
    ...
    public void setSavesOf(int piece, int saves) {
        if (piece<0 || piece>9) throw new IllegalArgumentException("Invalid piece code");
     ...
     */
    public int getSavesOf(int piece) {return this.saves[piece];}
    /**
     * Sets total saves
     * @param saves Saves to be set
     * @pre saves>=0
     ...
     */
    public int getTotalSaves() {return this.totalSaves;}
    /**
     ...
     */
    public int getCapturesOf(int piece) {return this.captures[piece];}
     ...
     */
    public int getTotalCaptures() {return this.totalCaptures;}
     ...
     */
    public int getSuccessfulAttacks() {return this.successfulAttacks;}
    /**
     * Sets total moves
     ...
     * @post all stats are set to 0
     */
    public void resetPlayer() {
        this.army.resetArmy();
        this.flag=true;
        this.saves = new int[10];
        this.captures = new int[10];
        for (int i=0; i<Army.PIECE_TYPES; i++) {
            this.setCapturesOf(i, 0);
            this.setSavesOf(i, 0);
        }
